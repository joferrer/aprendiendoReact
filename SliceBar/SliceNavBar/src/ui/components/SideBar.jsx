...
import {Box,Drawer,AppBar,Toolbar,List,CssBaseline,Typography,Divider,IconButton,ListItem,ListItemIcon,ListItemButton,
  ListItemText,
...
export const  SideBar=({children})=> {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBarComp position="fixed" open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          {['Inbox', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                >
                  {index % 2 === 0 ? <MoveToInbox color='primary' /> : <Mail color='primary'/>}
                </ListItemIcon>
